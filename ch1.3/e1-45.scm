...
;; the average-damped y ↦ x / y 2 . Unfortunately, the process does not work for
;; fourth roots—a single average damp is not enough to make a fixed-point search
;; for y ↦ x / y 3 converge. On the other hand, if we average damp twice (i.e., use
;; the average damp of the average damp of y ↦ x / y 3 ) the fixed-point search
...
;; for computing n th roots using fixed-point, average-damp, and the repeated
