...
;;
;; 2. Accumulate takes as arguments the same term and range specifications as sum
...
;; as simple calls to accumulate.  If your accumulate procedure generates a
;; recursive process, write one that generates an iterative process. If it
