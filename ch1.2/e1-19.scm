...
;; state variables a and b in the fib-iter process of section 1.2.2: a a + b and b
;; a. Call this transformation T, and observe that applying T over and over again
...
;; of the transformation T, starting with the pair (1,0). Now consider T to be the
;; special case of p = 0 and q = 1 in a family of transformations Tpq, where Tpq
;; transforms the pair (a,b) according to a bq + aq + ap and b bp + aq. Show that
;; if we apply such a transformation Tpq twice, the effect is the same as using a
;; single transformation Tp'q' of the same form, and compute p' and q' in terms of
;; p and q. This gives us an explicit way to square these transformations, and
